...
const data: any = {
  ...
  champions: [120, 100, 80, 60, 40, 30, 10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,],
      "Challenger 1": [120, 110, 100, 90, 80, 70, 60, 50, 40, 30, 20, 20,20, 20,20, 20,20, 20,20, 20,20, 20,20, 20,20, 20,20, 20,20, 20,],
        "Challenger 2": [120, 120, 110, 100, 90, 80, 70, 60, 50, 40, 30, 30,30, 30, 30,30, 30, 30,30, 30, 30,30, 30, 30,30, 30, 30,30, 30, 30,30, 30, 30],
      name: [
...
const CycleLiquidationChart: React.FC = ({  }) => {

    const chartData = data.name.map((_:any, index:any) => ({
        name: data.name[index],
        champions: data.champions[index],
        "Challenger 1": data["Challenger 1"][index],
      "Challenger 2": data["Challenger 2"][index],
      }));
  ...
  return (
    <div className="w-full xl:w-[49%] ml-3 h-[368px]  flex flex-col justify-center items-center border-[#E3E3E3] border-[1px]  rounded-xl  ">
...
export default CycleLiquidationChart;
